...
def alt_fib(n, first = 0, second = 1):
    ...
    The default values for first and second are 0 and 1,
    respectively'''
    return first if n == 1 else fib_alt(n - 1, second, first + second)      #It returns the first value if n is equal to one. Otherwise, it runs itself but with n - 1 instead of n,
